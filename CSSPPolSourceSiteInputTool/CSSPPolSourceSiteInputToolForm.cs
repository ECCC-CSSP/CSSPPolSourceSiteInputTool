    ...
    public partial class CSSPPolSourceSiteInputToolForm : Form
    {
        ...
        private void checkBoxAdmin_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (checkBoxShowAdmin.Checked)
            {
                ...
                // TODO: directly send email to webtools
//                string email = UserPrincipal.Current.EmailAddress;
        ...
        private void checkBoxShowContact_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (checkBoxShowInfrastructureAndContact.Checked)
            {
                ...
                polSourceSiteInputToolHelper.DrawPanelContactsAndInfrastructures();
            }
        }
        ...
        private async void ComboBoxProvinceNamesSelectedIndexChanged()
        {
            ...
            comboBoxSubsectorOrMunicipality.Visible = false;
        ...
        private void initializeAdminList()
        {
            ...
            adminList.Add("cormierca", "Carlo.Cormier@ec.gc.ca");
            adminList.Add("leblanclo", "louisphilippe.leblanc@ec.gc.ca");
